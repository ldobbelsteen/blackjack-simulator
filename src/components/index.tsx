...
export function Index() {
  ...
  const [strategy, setStrategy] = useStrategyPersistent(
    EditableStrategy.default(),
  );
  ...
  return (
    <main className="m-auto max-w-3xl shrink-0 grow overflow-hidden">
      ...
      <p>
        ...
        rules you are using. It implements the game of blackjack to a very
        detailed level so the results are representative of real-world results.
        Do realise, however, that these results are only achieved on the
        long-term and on the short-term your results will vary wildly. The
        simulator speed is dependent on your device&apos;s processing power as
        it is run locally. Only modern browsers are supported. This project is
        open source and can be found on{" "}
        <a href="https://github.com/ldobbelsteen/blackjack-simulator">GitHub</a>
        .
      </p>
      <br />
